...
export const references: Record<string, Reference> = {
  ...
  britannica_theaceae: {
    ...
    url: "https://www.britannica.com/plant/Theaceae",
  },
  rhs_camellia: {
    ...
    url: "https://www.rhs.org.uk/plants/2867/camellia-sinensis/details",
  },
  villa_landraces: {
    authors: "Villa, T.C.C., Maxted, N., Scholten, M., & Ford-Lloyd, B.",
    year: 2005,
    title: "Defining and identifying crop landraces",
    source: "Plant Genetic Resources, 3(3), 373-384",
    url: "https://doi.org/10.1079/PGR200591",
  },
  ishs_cultivars: {
    authors: "International Society for Horticultural Science",
    year: 2016,
    title: "International Code of Nomenclature for Cultivated Plants (9th Edition)",
    source: "Scripta Horticulturae, 18",
  ...
  fao2022: {
    ...
    year: 2022,
    title: "Current Market Situation and Medium Term Outlook for Tea to 2032",
    source: "FAO Intergovernmental Group on Tea",
    url: "https://openknowledge.fao.org/server/api/core/bitstreams/c1cad039-4e40-4888-bc74-3073d3ed7963/content",
  },
  tbrs2023: {
    authors: "Tea and Beverage Research Station",
    year: 2023,
    title: "Tea Cultivars",
    source: "Tea and Beverage Research Station",
    url: "https://www.tbrs.gov.tw/en/ws.php?id=4846",
  },
  statista2016: {
    authors: "Statista Research Department",
    year: 2016,
    title: "Global per capita tea consumption by country",
    source: "Statista",
    url: "https://www.statista.com/statistics/507950/global-per-capita-tea-consumption-by-country/",
  },
  caykur2025: {
    authors: "Caykur",
    year: 2025,
    title: "About Us",
    source: "Caykur",
    url: "https://www.caykur.gov.tr/Pages/Kurumsal/KurumHakkinda.aspx",
  },
  uk_turkey_fta: {
    authors: "UK Government",
    year: 2021,
    title: "UK-Turkey Free Trade Agreement",
    source: "UK Government Publications",
    url: "https://assets.publishing.service.gov.uk/media/60350bd28fa8f543272b402e/CS_Turkey_1.2021_UK_Turkey_Free_Trade_Agreement.pdf",
  },
  barrys_tea: {
    authors: "Barry's Tea",
    year: 2023,
    title: "About Us",
    source: "Barry's Tea Official Website",
    url: "https://www.barrystea.ie/about-us/",
  },
  klipopmekaar2023: {
    authors: "Klipopmekaar Rooibos",
    year: 2023,
    title: "Rooibos Tea Processing",
    source: "Klipopmekaar Rooibos Official Website",
    url: "https://www.klipopmekaar.co.za/rooibos-tea-processing/",
  },
  redespresso2023: {
    authors: "Red Espresso",
    year: 2023,
    title: "Rooibos Red Cappuccino",
    source: "Red Espresso Official Website",
  ...
  theanine_umami: {
    authors: "Shu Kaneko, Kenji Kumazawa, Hideki Masuda, Andrea Henze, and Thomas Hofmann",
    year: 2006,
    title: "Molecular and Sensory Studies on the Umami Taste of Japanese Green Tea",
    source: "Journal of Agricultural and Food Chemistry, 54 (7), 2688-2694",
    url: "https://pubs.acs.org/doi/10.1021/jf0525232",
  },
  theanine_caffeine: {
