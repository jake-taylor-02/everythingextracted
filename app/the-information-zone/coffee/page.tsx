          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-8">
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Coffee</h1>
                <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">Where do we even start...</p>
              </div>
            </div>
