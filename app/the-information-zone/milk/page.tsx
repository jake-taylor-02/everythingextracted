          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-8">
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Milk</h1>
                <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                  Dairy and non-dairy options for your beverages
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              <Card className="group overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm transition-all hover:shadow-md hover:-translate-y-1 duration-300 flex flex-col">
                <CardHeader className="p-6 pb-0">
                  <CardTitle>Dairy Milk</CardTitle>
                  <CardDescription>The milk that started it all</CardDescription>
                </CardHeader>
                <CardContent className="p-6 pt-4 flex flex-col flex-1">
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      ...
                      <Link href="/the-information-zone/milk/dairy-milk/history" className="hover:underline">
                  ...
                  <div className="mt-auto pt-4">
                    <Button asChild variant="outline" size="sm" className="w-full h-10">
                      <Link href="/the-information-zone/milk/dairy-milk">Learn More</Link>
                    </Button>
                  </div>
                </CardContent>
              </Card>
